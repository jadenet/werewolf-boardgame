...
export function getPhaseAnnouncement(currentPhase: Round["status"]) {
  switch (currentPhase) {
    case "PreGame":
      return "Roles have been dealt. Get ready...";
    case "Discussion":
      return "Sun's up! Discuss what you saw and heard overnight.";
    case "Voting":
      return "Time to vote. Choose who you think is the Werewolf.";
    case "Night":
      return "Night has fallen. Everyone close your eyes.";
    case "End":
